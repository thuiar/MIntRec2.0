...
def save_results(args, test_results, debug_args = None):
    ...
    _vars = [args.dataset, args.ood_dataset, args.method, args.ood_detection_method, args.text_backbone, args.video_feats, args.audio_feats, args.seed, args.log_id]
    _names = ['dataset', 'ood_dataset', 'method', 'ood_detection_method', 'text_backbone', 'video_feats', 'audio_feats',  'seed', 'log_id']
